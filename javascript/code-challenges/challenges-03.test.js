...
const typeNum = (arr) => {
  // Solution code here...
  const result =arr.filter((val)=>typeof(val) =='number')
  return result
};
...
const containsAnd = (arr) => {
  // Solution code here...
  const result =arr.filter((val)=>val.includes('and')==true)
  return result
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const result =arr.filter((val)=>forbiddenValues.includes(val)==false)
  return result
};
